<?php get_header(); ?>
    ...
    <?php
      $blog_page_id = 8;
      if(get_field('show_bluebar', $blog_page_id)): ?>
      <div class="bluebar">
        <h1><?php the_field('bluebar_title', $blog_page_id); ?></h1>
        <?php the_field('bluebar_text', $blog_page_id); ?>
      </div>
    <?php endif; ?>
    <div class="main">
      <div class="container">
        ...
        <div class="row" id="posts">
          <?php
            ...
            $query = new WP_Query(array('posts_per_page' => $ppp, 'paged' => $paged, 'category_name' => $cat[0]->name));

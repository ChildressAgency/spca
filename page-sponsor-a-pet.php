          ...
          <div class="col-sm-8">
            <div class="row icon-row">
              <div class="col-sm-4 border-right">
                <p>Front Page Promotion<span>(On Website)</span></p>
              </div>
              <div class="col-sm-4 border-right">
                <p>Online Promotion Twitter &amp; Facebook<span>(100K+ Following)</span></p>
              </div>
              <div class="col-sm-4">
                <p>Personal Animal Visits<span>(On Request)</span></p>
              </div>
            </div>
            <div class="content">
